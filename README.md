...
- 🔄 Automatic TypeScript file generation with both types and runtime exports from i18n modules
...
unpluginVueI18nDtsGeneration({
  ...
  tsPath: 'src/i18n/i18n.gen.ts',  // Custom output path (default: src/i18n/i18n.gen.ts)
...
The plugin will generate a TypeScript file with both type definitions and runtime exports:

```typescript
// src/i18n/i18n.gen.ts
...
export const messages = { /* your i18n message structure */ } as const
...
export type AllTranslationsGen = typeof messages
export const messagesI18n = _messagesI18n as unknown as AllTranslationsGen
```

### Using the Generated Types and Exports with Vue I18n
...
// Type-safe i18n instance with imported messages
export const i18n = createI18n<[AllLocaleGen], SupportedLanguagesGen, false>({
  legacy: false,
  locale: 'en',
  messages: messagesI18n, // Use the imported messages directly
  // Your other i18n configuration
})
...
5. Generates deterministic TypeScript file with both type definitions and runtime exports
6. Writes the generated TypeScript file to the specified path
...
- Using the generated runtime exports
