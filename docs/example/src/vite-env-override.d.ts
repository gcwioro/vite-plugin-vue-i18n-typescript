...
// declare global {
//    const _MessageScheme = {"App":{"fruits":{"apple":"kein Apfel | ein Apfel | {n} Äpfel","banana":"keine Banane | eine Banane | {count} Bananen","label":"Du hast keine {fruit} | Du hast eine {fruit} | Du hast {count} {fruit}"},"fruitsLabel":"Es gibt keine Früchte | Es gibt eine Frucht | Es gibt {count} Früchte","menu":["ddStadrteite","Über uns","Kontakt","Hilzsffe","dd"]},"FileMergingDemo":{"description":"This component demonstrates how translation keys from multiple files are automatically merged together","feature":{"autoMerge":"Files are discovered and merged automatically by the plugin","hotReload":"Changes to any translation file trigger hot module replacement","typeCheck":"All merged keys maintain full TypeScript type checking"},"merged":{"success":"Successfully merged {count} top-level translation namespaces!","typeSafety":"Every key has autocomplete support in your IDE"},"title":"Multi-File Translation Support"},"Greeting":{"greetings":"unplug-i18n-dts-generation Plugin - Demo Projekt","message":"Hallo TypeScript Freunde!"},"InterpolationDemo":{"birthday":"Nächstes Jahr wirst du {age}!","profile":"{name} ist {age} Jahre alt","welcome":"Willkommen, {name}!"},"LanguageDropdown":{"label":"Sprache:"},"NestedKeysDemo":{"settings":{"notifications":{"description":"E-Mail- und Push-Benachrichtigungen","label":"Benachrichtigungen"},"privacy":{"description":"Wer kann Ihre Daten sehen","label":"Datenschutz-Kontrollen"},"theme":{"description":"Dunkler oder heller Modus","label":"Design-Einstellungen"}},"status":{"error":"Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.","success":"Operation erfolgreich abgeschlossen!","warning":"Bitte überprüfen Sie Ihre Änderungen, bevor Sie fortfahren."}},"Pluralidzaodesds":{"cart":{"status":"Ihr Warenkorb ist leer | Sie haben einen Artikel im Warenkorb | Sie haben {n} Artikel im Warenkorb"},"explanation":{"format":"Format: 'null | eins | viele'","note":"Der {n}-Wert bestimmt welche Form verwendet wird: 0=erste, 1=zweite, 2+=dritte","parameter":"Übergeben Sie den Parameter {n} mit dem Zählwert"},"files":{"uploaded":"keine Dateien hochgeladen | {n} Datei hochgeladen | {n} Dateien hochgeladen"},"items":"keidne Artikel | ein Artikel | {n} Artikel","messages":"keine Nachrichten | eine Nachricht | {n} Nachrichten","notifications":{"unread":"keine ungelesenen Benachrichtigungen | eine ungelesene Benachrichtigung | {n} ungelesene Benachrichtigungen"},"people":"niemand | {n} Person | {n} Personen"},"PluralizationDemo":{"cart":{"status":"Your cart is empty | You have one item in your cart | You have {count} items in your cart"},"explanation":{"format":"Format: 'zero | one | many'","note":"The {count} value determines which form is used: 0=first, 1=second, 2+=third","parameter":"Pass {count} parameter matching the count value"},"files":{"uploaded":"no files uploaded | one file uploaded | {count} files uploaded"},"items":"no items | one item | {count} items","messages":"no messages | one message | {count} message","notifications":{"unread":"no unread notifications | one unread notification | {n} unread notifications"},"people":"nobody | one person | {count} people","title":"Pluralization Examples"},"TestHotUpdate":{"message":"This is a test for hot module replacement"}};
//    type _MessageSchemeType = typeof _MessageScheme;
//    const _AllTranslationKeys = 'App.fruits.apple' | 'App.fruits.banana' | 'App.fruits.label' | 'App.fruitsLabel' | 'App.menu' | 'App.menu.0' | 'App.menu.1' | 'App.menu.2' | 'App.menu.3' | 'App.menu.4' | 'FileMergingDemo.description' | 'FileMergingDemo.feature.autoMerge' | 'FileMergingDemo.feature.hotReload' | 'FileMergingDemo.feature.typeCheck' | 'FileMergingDemo.merged.success' | 'FileMergingDemo.merged.typeSafety' | 'FileMergingDemo.title' | 'Greeting.greetings' | 'Greeting.message' | 'InterpolationDemo.birthday' | 'InterpolationDemo.profile' | 'InterpolationDemo.welcome' | 'LanguageDropdown.label' | 'NestedKeysDemo.settings.notifications.description' | 'NestedKeysDemo.settings.notifications.label' | 'NestedKeysDemo.settings.privacy.description' | 'NestedKeysDemo.settings.privacy.label' | 'NestedKeysDemo.settings.theme.description' | 'NestedKeysDemo.settings.theme.label' | 'NestedKeysDemo.status.error' | 'NestedKeysDemo.status.success' | 'NestedKeysDemo.status.warning' | 'Pluralidzaodesds.cart.status' | 'Pluralidzaodesds.explanation.format' | 'Pluralidzaodesds.explanation.note' | 'Pluralidzaodesds.explanation.parameter' | 'Pluralidzaodesds.files.uploaded' | 'Pluralidzaodesds.items' | 'Pluralidzaodesds.messages' | 'Pluralidzaodesds.notifications.unread' | 'Pluralidzaodesds.people' | 'PluralizationDemo.cart.status' | 'PluralizationDemo.explanation.format' | 'PluralizationDemo.explanation.note' | 'PluralizationDemo.explanation.parameter' | 'PluralizationDemo.files.uploaded' | 'PluralizationDemo.items' | 'PluralizationDemo.messages' | 'PluralizationDemo.notifications.unread' | 'PluralizationDemo.people' | 'PluralizationDemo.title' | 'TestHotUpdate.message';
...
// declare module 'vue-i18n' {
  // type messageScheme = {"App":{"fruits":{"apple":"kein Apfel | ein Apfel | {n} Äpfel","banana":"keine Banane | eine Banane | {count} Bananen","label":"Du hast keine {fruit} | Du hast eine {fruit} | Du hast {count} {fruit}"},"fruitsLabel":"Es gibt keine Früchte | Es gibt eine Frucht | Es gibt {count} Früchte","menu":["ddStadrteite","Über uns","Kontakt","Hilzsffe","dd"]},"FileMergingDemo":{"description":"This component demonstrates how translation keys from multiple files are automatically merged together","feature":{"autoMerge":"Files are discovered and merged automatically by the plugin","hotReload":"Changes to any translation file trigger hot module replacement","typeCheck":"All merged keys maintain full TypeScript type checking"},"merged":{"success":"Successfully merged {count} top-level translation namespaces!","typeSafety":"Every key has autocomplete support in your IDE"},"title":"Multi-File Translation Support"},"Greeting":{"greetings":"unplug-i18n-dts-generation Plugin - Demo Projekt","message":"Hallo TypeScript Freunde!"},"InterpolationDemo":{"birthday":"Nächstes Jahr wirst du {age}!","profile":"{name} ist {age} Jahre alt","welcome":"Willkommen, {name}!"},"LanguageDropdown":{"label":"Sprache:"},"NestedKeysDemo":{"settings":{"notifications":{"description":"E-Mail- und Push-Benachrichtigungen","label":"Benachrichtigungen"},"privacy":{"description":"Wer kann Ihre Daten sehen","label":"Datenschutz-Kontrollen"},"theme":{"description":"Dunkler oder heller Modus","label":"Design-Einstellungen"}},"status":{"error":"Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.","success":"Operation erfolgreich abgeschlossen!","warning":"Bitte überprüfen Sie Ihre Änderungen, bevor Sie fortfahren."}},"Pluralidzaodesds":{"cart":{"status":"Ihr Warenkorb ist leer | Sie haben einen Artikel im Warenkorb | Sie haben {n} Artikel im Warenkorb"},"explanation":{"format":"Format: 'null | eins | viele'","note":"Der {n}-Wert bestimmt welche Form verwendet wird: 0=erste, 1=zweite, 2+=dritte","parameter":"Übergeben Sie den Parameter {n} mit dem Zählwert"},"files":{"uploaded":"keine Dateien hochgeladen | {n} Datei hochgeladen | {n} Dateien hochgeladen"},"items":"keidne Artikel | ein Artikel | {n} Artikel","messages":"keine Nachrichten | eine Nachricht | {n} Nachrichten","notifications":{"unread":"keine ungelesenen Benachrichtigungen | eine ungelesene Benachrichtigung | {n} ungelesene Benachrichtigungen"},"people":"niemand | {n} Person | {n} Personen"},"PluralizationDemo":{"cart":{"status":"Your cart is empty | You have one item in your cart | You have {count} items in your cart"},"explanation":{"format":"Format: 'zero | one | many'","note":"The {count} value determines which form is used: 0=first, 1=second, 2+=third","parameter":"Pass {count} parameter matching the count value"},"files":{"uploaded":"no files uploaded | one file uploaded | {count} files uploaded"},"items":"no items | one item | {count} items","messages":"no messages | one message | {count} message","notifications":{"unread":"no unread notifications | one unread notification | {n} unread notifications"},"people":"nobody | one person | {count} people","title":"Pluralization Examples"},"TestHotUpdate":{"message":"This is a test for hot module replacement"}}
