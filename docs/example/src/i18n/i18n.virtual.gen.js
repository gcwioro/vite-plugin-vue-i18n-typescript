...
function hrmHotUpdate(messages3, data, app, deepMerge3) {
  ...
  if (data.messages) {
    ...
    const mergedMessages = Object.assign({}, messages3, deepMerge3(data.messages.messages, messages3));
    if (i18nModule) {
