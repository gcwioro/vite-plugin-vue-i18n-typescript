...
export const messages = {"en":{"App":{"fruits":{"apple":"Apple | Apples","banana":"Banana | Bananas"},"greetings":"Hello Typescript friends!","menu":["home","about"]}}} as const
