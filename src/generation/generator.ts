 ...
 */
export function toVirtualModuleContent( messagesCombined: CombinedMessages): string {
return createVirtualModuleCode(messagesCombined).toFileContent('messages');
}
 ...
 */
export function createVirtualModuleCode( messagesCombined: CombinedMessages): RuntimeMethods {
