 ...
 */
export function toVirtualModuleContent(opts: RuntimeGenerationParams, messagesCombined: CombinedMessages) {
return createVirtualModuleCode(opts,messagesCombined);
 ...
 */
export function createVirtualModuleCode(opts: RuntimeGenerationParams, messagesCombined: CombinedMessages) {
  // const {messagesCombined, baseLocale, buildAssetRefId, devUrlPath, virtualJsonId} = opts;
// const {messagesCombined:x, ...config} = opts;
  // const messages = messagesCombined.messages;
  // const supportedLanguages = messagesCombined.languages;
  // const languagesTuple = messagesCombined.languagesTuple();
