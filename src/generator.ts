 ...
 */
export function toTypesContent(params: DtsContentParams): string {
  const {
    baseLocale,
    messages,
    supportedLanguages,
...
import type { AllTranslationsGen, SupportedLanguagesGen, SupportedLanguageUnionGen, AllTranslationKeysGen } from './i18n.types'
 ...
 * @deprecated Use toTypesContent and toConstsContent for separate file generation
 */
